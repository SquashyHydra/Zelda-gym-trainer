...
def calc_action_rew(seen_tile_coords, ai_action, total_action_reward, last_seen_tile_coords, reward_scale):
    if seen_tile_coords:
        if ai_action > 4 and ai_action < 5:
            total_action_reward += reward_scale * 0.005
        elif ai_action <= 4 and last_seen_tile_coords != seen_tile_coords:
            total_action_reward += reward_scale * 0.05
        elif ai_action <= 4 and last_seen_tile_coords == seen_tile_coords:
